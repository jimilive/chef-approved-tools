...
export const METADATA = {
  ...
  pages: {
    ...
    'about': {
      ...
      description: "Kitchen Manager at Purple Café, line cook at Feierabend—24 years testing what actually lasts in professional kitchens vs. what breaks in 6 months.",
...
'bacon-but-not-in-this-dish': {
    ...
    'victorinox-budget-vs-wusthof-premium-knives': {
      ...
      imageAlt: "Victorinox Budget vs Wüsthof Premium Knives Comparison",
      keywords: {
        primary: "victorinox vs wusthof",
        secondary: ["budget chef knife","premium chef knife","victorinox fibrox","wusthof classic","best value chef knife"],
        searchVolume: 1200,
        difficulty: "medium",
      },
      publishedDate: "2025-11-15",
      ...
      lastUpdated: "2025-11-15",
      modifiedTime: "2025-11-15T13:00:00Z",
      searchIntent: "commercial",
      conversionPotential: "high",
      articleSection: "Kitchen Equipment",
      internalLinks: ["complete-victorinox-knife-lineup-comparison", "victorinox-fibrox-8-inch-chefs-knife", "paring-knife-vs-chefs-knife"],
      competitorUrls: [],
