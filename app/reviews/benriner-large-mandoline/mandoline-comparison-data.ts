...
export const mandolineComparisonData = {
  products: [
    // BENRINER SUPER BENRINER - The Featured Product
    {
      name: 'Super Benriner',
      brand: 'Benriner',
      affiliateLink: 'https://amzn.to/47NKzE8',
    ...
    // OXO GOOD GRIPS CHEF'S MANDOLINE 2.0
    {
      ...
      brand: 'OXO',
      affiliateLink: 'https://amzn.to/4ijz9eX',
    ...
    // SWISSMAR BÖRNER V-SLICER PLUS
    {
      ...
      affiliateLink: 'https://amzn.to/4abvRbG',
    ...
    // DASH SAFE SLICE
    {
      name: 'Safe Slice',
      brand: 'DASH',
      affiliateLink: 'https://amzn.to/44uSQL7',
