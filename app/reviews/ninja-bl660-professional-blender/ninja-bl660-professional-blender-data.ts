/**
 * Ninja BL660 Professional Blender Review Data
 *
 * This file contains all content for the Ninja BL660 blender review page.
...
export const reviewData = {
  ...
  // BREADCRUMB
  breadcrumb: {
    productName: "Ninja BL660 Professional Blender"
  },
  ...
  qualityControlWarning: {
    title: "Quality Control Issue Discovered",
    intro: "Within 2 weeks of careful use, a small crack appeared in the pitcher base where the blade assembly seals into the container. This is a concerning quality control issue that could lead to leaking or complete pitcher failure. I'm continuing to test to see if the crack progresses, but this raises serious questions about long-term durability.",
    ...
    tests: [
      {
        ...
        sections: [
          ...
          },
          {
            ...
            content: "The Vitamix would have powered through my overloaded first attempt without complaint. The Vitamix creates a tighter vortex and can handle thicker mixtures with the tamper accessory. However, for standard smoothies with proper liquid ratio, the BL660 produces comparable results at 1/5 the price."
          }
        ]
      },
      {
        title: "Wing Sauce Test (The Emulsification Challenge)",
        sections: [
          {
            subtitle: "Background",
          ...
          {
            subtitle: "Setup",
            content: "1 cup melted butter (hot), 1 cup Frank's RedHot, 2 cloves garlic, 1 tablespoon white vinegar, cayenne and black pepper to taste. Blended on high for 60 seconds."
          },
          {
            subtitle: "Results",
      ...
      {
        title: "Margarita Test (Frozen Drinks & Ice Crushing)",
        sections: [
          {
            subtitle: "Setup",
      ...
      {
        title: "The Quality Control Issue (Critical Concern)",
        sections: [
          {
            subtitle: "Timeline",
          ...
          {
            subtitle: "Location",
            content: "Small crack (approximately 1/4 inch) in the pitcher base where the black plastic blade holder seals into the clear plastic pitcher. It appears to be a stress crack from the blade assembly pressure or thermal expansion/contraction during use."
          },
          {
            subtitle: "Current status",
            content: "Crack hasn't progressed significantly in the subsequent 10 weeks, no leaking during use, but this is a serious red flag for long-term durability. I will document how Ninja's customer service handles warranty replacement in future updates."
          }
        ]
      }
    ]
  ...
  whereToBuy: {
    title: "Where to Buy",
    introText: "The Ninja BL660 is available through Amazon with Prime shipping and easy returns. At ~$80-100, inspect carefully upon arrival and test within the return window.",
  ...
  bottomLine: {
    ...
    finalRating: {
      overall: "⭐⭐⭐⭐ 3.8/5",
      breakdown: [
        "Smoothie Performance (with liquid): 4/5",
        "Emulsification (sauces): 4.5/5",
        "Ice Crushing: 4/5",
        "Build Quality & Durability: 2/5 (quality control issue)",
        "Value for Money: 4/5 (if it lasts)"
      ],
      wouldBuyAgain: "Would I buy this again? Only if I needed a budget blender for occasional use and understood it's a 2-3 year appliance. For regular blending, I'd save up for Vitamix."
    },
    ctaText: "Check Amazon Price →"
  },
    ...
    products: [
      {
        ...
        description: "Professional knife for prepping smoothie ingredients. Perfect balance and edge retention for daily use.",
        href: "/reviews/victorinox-fibrox-8-inch-chefs-knife"
      },
      {
        emoji: "📋",
        name: "John Boos Cutting Board",
        description: "The prep surface for staging blender ingredients. Commercial-quality board that's lasted 14 years.",
  ...
  legacyProductData: {
    name: "Ninja BL660 Professional Blender",
    ...
    pros: [
      ...
      "Dishwasher-safe pitcher and components",
    ...
    cons: [
      ...
      "Expected lifespan only 2-3 years with regular use",
      "Extremely sharp blades are a safety concern",
      "Standard blender noise level (85-90 dB)",
      "Only 1-year warranty vs. Vitamix's 7-10 years"
    ],
    affiliateLinks: [],
    inStock: true,
    expertRating: 3.8,
