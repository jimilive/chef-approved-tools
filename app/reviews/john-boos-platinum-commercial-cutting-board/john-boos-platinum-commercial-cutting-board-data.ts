...
export const reviewData = {
  // METADATA
  metadata: {
    title: "John Boos Cutting Board: 18 Years of Daily Use (Generational Quality)",
    description: "Sanded once. Oiled occasionally. John Boos commercial cutting board still perfect after 18 years of daily chopping. $150 that lasts generations.",
  ...
  // SECTION 1: HERO
  hero: {
    title: "John Boos Platinum Cutting Board | 18-Year Review",
  ...
  testingResults: {
    title: "Testing Results: 18 Years of Daily Home Use",
    introText: "Over 18 years of daily home cooking, <LINK>this cutting board</LINK> has proven itself as professional-grade equipment that delivers generational value. Here's what extensive real-world testing revealed:",
    sections: [
      {
      ...
      },
      {
        ...
        content: "Despite marketing claims about frequent oiling, the maintenance reality is far simpler. I rarely oil this board but keep it clean and never soak in water. Basic washing with warm soapy water after use, immediate drying, and occasional oiling (2-3 times per year) has proven sufficient for 18 years of performance. The maintenance requirements are far less demanding than manufacturers suggest."
      },
      {
        title: "Food Safety Performance",
        content: "After 18 years, I've never had any food safety concerns. Simple washing with warm soapy water maintains proper sanitation. Unlike concerns about bacteria in wood cutting boards, proper cleanliness practices have proven completely sufficient. The board is easy to sanitize and has never posed any hygiene issues."
      }
    ],
    testingEnvironment: [
      {
        label: "Testing Duration",
        value: "18 years of daily home cooking"
      },
      {
        label: "Use Context",
    ...
    outstandingPerformance: [
      ...
      "After 18 years of daily use, expect another 20 years easily - genuine generational longevity",
  ...
  legacyProductData: {
    ...
    expertRating: 4.8,
    expertOpinion: "After 18 years of daily home use, this John Boos cutting board represents the #1 choice for serious home cooks. Made from sustainable Northern Hard Rock Maple with NSF certification, it's built to professional standards. The 1.75-inch edge-grain construction resists deep cuts while being knife-friendly to preserve blade sharpness.",
    pros: [
