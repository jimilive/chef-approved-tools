/**
 * Rubbermaid Commercial Cook's Scraper Review Data
 *
 * This file contains all content for the Rubbermaid Commercial Cook's Scraper review page.
...
export const reviewData = {
  // METADATA
  metadata: {
    title: "The $8 High-Heat Scraper That Survived 18 Years (500°F Rated)",
    description: "Rubbermaid Commercial scraper tested 18 years across two restaurant kitchens. Handles 500°F griddles, never melts. The buy-it-for-life kitchen scraper.",
    ...
    ogTitle: "The $8 High-Heat Scraper That Survived 18 Years (500°F Rated)",
    ogDescription: "Rubbermaid Commercial scraper tested 18 years across two restaurant kitchens. Handles 500°F griddles, never melts. The buy-it-for-life kitchen scraper.",
  ...
  // BREADCRUMB
  breadcrumb: {
    productName: "Rubbermaid Commercial Cook's Scraper / Spatula (13.5-inch)"
  },
  ...
  quickStats: {
    rating: 4.7,
    testingPeriod: "18-Year Real-World Test",
    features: [
  ...
  primaryCTA: {
    ...
    sizes: [
      {
        name: "13.5-inch (Professional/Large Batches)",
        description: "13.5-inch (Professional/Large Batches):",
        linkIndex: 0
      },
      {
        name: "9.5-inch (Home Kitchens - Recommended)",
        description: "9.5-inch (Home Kitchens - Recommended):",
        linkIndex: 1
      }
    ],
    note: "💡 We earn a commission at no extra cost to you."
  },
  ...
  // HERO FEATURES
  heroFeatures: {
    title: "Why This $15-20 Professional Kitchen Spatula Outlasted Everything Else",
    features: [
      {
        emoji: "🔥",
        title: "500°F Heat Resistance",
        description: "This high-heat spatula won't melt on hot pans like cheap alternatives. Withstands commercial kitchen heat without degradation. After 18 years of hot pan contact with this rubber spatula, it still functions perfectly."
      },
      {
        emoji: "🛡️",
      ...
      },
      {
        emoji: "✓",
        title: "NSF Certified",
        description: "Meets strict commercial food safety standards. The same certification required in professional kitchens, now available for home use."
      },
      {
        emoji: "💰",
        title: "Built to Last",
  ...
  testingResults: {
    ...
    performanceMetrics: {
      ...
      metrics: [
        { label: "Durability", value: "18 years of daily use, zero repairs needed" },
        { label: "Heat Resistance", value: "500°F rating confirmed through real-world hot pan contact" },
        { label: "Sanitation", value: "Commercial dishwasher safe, NSF certified, no bacterial buildup" },
        { label: "Blade Condition", value: "Maintains flexibility and effectiveness after 18 years" },
        { label: "Handle Integrity", value: "One-piece construction shows no separation or cracking" },
        { label: "Value", value: "$15-20 investment / 18 years = exceptional cost per use" }
      ]
    }
  },
  ...
  comparisons: {
    ...
    sections: [
      {
        title: "vs Cheap Grocery Store Spatulas ($3-8)",
        rubbermaidAdvantages: {
          title: "✅ Rubbermaid Commercial Advantages",
          points: [
            "500°F heat resistance vs typically unrated or 250°F",
            "18 year lifespan vs 6-12 month replacement cycle",
            "One-piece construction vs handle separation issues",
            "NSF certified for commercial sanitation standards",
            "Made in USA with quality control"
          ]
        },
        competitorProblems: {
          title: "Cheap Spatula Problems",
          points: [
            "Melts on contact with warm pans",
            "Handle separates from blade within months",
            "Low-grade plastic/rubber degrades quickly",
            "No heat resistance rating or certification",
            "Annual replacement needed = higher long-term cost"
          ]
        },
        verdict: "The $10-15 price difference is recovered within the first year through superior durability. Over 18 years, cheap spatulas would cost $90-180 in replacements vs one $15-20 Rubbermaid purchase."
      },
      {
        title: "vs Premium Silicone Spatulas ($25-40)",
        rubbermaidAdvantages: {
          title: "✅ Rubbermaid Strengths",
          points: [
            "33-50% lower cost with comparable durability",
            "Stiffer construction provides better leverage",
            "One-piece design easier to sanitize",
            "Proven 18 year longevity in real-world use"
          ]
        },
        competitorAdvantages: {
          title: "🟡 Premium Silicone Advantages",
          points: [
            "Superior flexibility for delicate folding",
            "Often higher heat ratings (600°F+)",
            "Better for fine pastry work and meringues",
            "Wider color selections hide staining"
          ]
        },
        verdict: "Premium silicone offers finesse; Rubbermaid offers value and durability. For everyday scraping and heavy-duty work, the Rubbermaid delivers 90% of functionality at 40-60% of the cost. Serious bakers may want both."
      },
      {
        title: "vs Wooden Spatulas ($8-20)",
        rubbermaidAdvantages: {
          title: "✅ Rubbermaid Hygiene Advantages",
          points: [
            "Non-porous surface prevents bacterial growth",
            "Commercial dishwasher safe for high-temp sanitization",
            "No cracks or crevices to trap food particles",
            "Never absorbs flavors or odors between dishes",
            "Zero maintenance required beyond washing",
            "NSF certified for commercial food safety"
          ]
        },
        competitorProblems: {
          title: "⚠️ Wood Spatula Issues",
          points: [
            "Porous material harbors bacteria in microscopic cracks",
            "Hand-wash only (dishwasher causes warping/cracking)",
            "Requires regular oiling to prevent drying",
            "Must replace when visible cracks appear",
            "Absorbs and transfers flavors between foods",
  ...
  // WHO SHOULD BUY
  whoShouldBuy: {
    title: "Who Should (and Shouldn't) Buy This Scraper",
    perfectFor: [
      "Professional kitchens and commercial operations",
      "Daily home cooking and meal prep",
      "Anyone wanting commercial-grade durability at consumer pricing",
      "Cooks prioritizing sanitation and easy cleaning",
      "Heavy-duty scraping of thick batters, doughs, and sauces",
      "Users tired of replacing cheap spatulas annually",
      "Anyone seeking genuine buy-it-for-life kitchen equipment"
    ],
    considerAlternatives: [
      "You primarily do delicate pastry work requiring extreme flexibility",
      "Pristine white appearance is a top priority",
      "You need maximum flexibility for folding meringues or soufflés",
      "You want the highest possible heat rating (600°F+)",
      "Color-coding different spatulas is important to your workflow"
    ]
  },
  ...
  // FAQ SCHEMA DATA (separate for schema markup)
  faqData: [
    {
  ...
  whereToBuy: {
    ...
    subtitle: "Compare Sizes & Prices:",
    sizes: [
      {
        name: "13.5-inch (Professional/Large Batches)",
        features: ["✓ Prime shipping", "✓ Fast delivery", "✓ Easy returns"],
        linkIndex: 0
      },
      {
        name: "9.5-inch (Home Kitchens - Most Popular)",
        features: ["✓ Perfect size for daily use", "✓ Best value", "✓ Recommended"],
        linkIndex: 1
      }
    ],
  ...
  finalVerdict: {
    ...
    headline: "After 18 Years of Professional and Home Use...",
    text: "Eighteen years. Two professional kitchens. Thousands of uses. This scraper cost less than $20 and has outlasted spatulas costing triple that amount. The one-piece construction means zero maintenance, the 500°F heat tolerance means it won't melt on hot pans, and the commercial-grade durability means this is truly buy-it-for-life equipment. Not fancy, but absolutely professional-grade.",
    ratings: {
      overall: 4.7,
      breakdown: [
        "Durability: 5/5 (18 years and counting)",
        "Value: 5/5 (exceptional cost per use)",
        "Heat Resistance: 5/5 (500°F proven)",
        "Sanitation: 5/5 (NSF certified, dishwasher safe)",
        "Flexibility: 4/5 (good leverage, adequate flex)"
      ],
      wouldBuyAgain: "Without hesitation. At this price point, there's nothing that competes with the durability and value."
    }
  },

  // ALTERNATIVES
  alternatives: {
    title: "Not Sure This Scraper Is Right for You? Consider These Alternatives:",
    sections: [
      {
        title: "If You Need Maximum Flexibility:",
        options: [
          {
            name: "Le Creuset Silicone Spatulas",
            price: "$25-35",
            description: "Superior flexibility for delicate folding and fine pastry work. Better for meringues and soufflés, but costs 2-3x more."
          },
          {
            name: "GIR Ultimate Spatula",
            price: "$30-40",
            description: "Premium silicone with ergonomic design. Excellent for serious bakers who need finesse over leverage."
          }
        ]
      },
      {
        title: "If Budget Is Your Main Concern:",
        options: [
          {
            name: "OXO Good Grips Silicone Spatula",
            price: "$10-15",
            description: "Decent consumer-grade option for occasional use. Won't last 18 years, but adequate for light home cooking."
          }
        ]
      },
      {
        title: "If You Want Higher Heat Rating:",
        options: [
          {
            name: "Rubbermaid High-Heat Version",
            price: "same price",
            description: "Available with red handle, features higher visibility. Same 500°F rating and durability."
          }
        ]
      }
    ]
