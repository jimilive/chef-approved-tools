...
export const chefKnifeComparisonData = {
  products: [
    // VICTORINOX FIBROX PRO 8-INCH - The Featured Product
    {
      name: 'Fibrox Pro 8-Inch',
      brand: 'Victorinox',
      affiliateLink: 'https://amzn.to/4o7BUSV',
    ...
    // MERCER GENESIS 8-INCH FORGED
    {
      ...
      brand: 'Mercer',
      affiliateLink: 'https://amzn.to/49z3Zy0',
    ...
    // WÜSTHOF GOURMET 8-INCH
    {
      name: 'Gourmet 8-Inch',
      brand: 'Wüsthof',
      affiliateLink: 'https://amzn.to/4pmxHe4',
    ...
    // MAC PROFESSIONAL 8-INCH
    {
      ...
      brand: 'Mac',
      affiliateLink: 'https://amzn.to/49EZguQ',
