          ...
          <div className="bg-white rounded-2xl px-6 pt-6 pb-12 md:px-12 shadow-sm mb-6">
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-8">
              ...
              <div className="text-slate-600 leading-[1.8]">
                <p className="mb-4">
                  <strong>Scott Bradley brings 24 years of professional kitchen experience to Chef Approved Tools.</strong> As former Kitchen Manager at Mellow Mushroom and Purple Café, he managed operations generating $80K+ monthly revenue while overseeing equipment procurement, staff training, and quality control.
                </p>
                ...
                <p className="mb-0">
                  <strong>All reviews are based on actual testing</strong>—equipment used daily in home settings or tested extensively over months. No free samples, no sponsored content, just honest assessments from someone who understands professional standards.
                </p>
              </div>
