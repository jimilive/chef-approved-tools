  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mb-8">
          <Image
            src="/images/products/oxo-bench-scraper/main.jpg"
        ...
        <section className="mb-12">
          ...
          <div className="mb-8">
            <Image
              src="/images/products/oxo-bench-scraper/brand.jpg"
        ...
        <section className="mb-12 bg-gradient-to-r from-orange-50 to-red-50 p-8 rounded-xl border-2 border-orange-200">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="https://www.amazon.com/OXO-Multi-purpose-Stainless-Scraper-Chopper/dp/B00004OCNJ?tag=chefapprovedt-20"
              target="_blank"
