/**
 * WÜSTHOF Classic IKON 16-Piece Review Data
 *
 * This file contains all content for the WÜSTHOF Classic IKON review page.
...
export const reviewData = {
  // METADATA
  metadata: {
    title: 'Wüsthof Classic Ikon 16-Piece Set: 6-Year Test (Worth $600?)',
  ...
  // BREADCRUMB
  breadcrumb: {
    productName: 'WÜSTHOF Classic IKON 16-Piece'
  },

  // SECTION 1: HERO
  hero: {
    title: 'WÜSTHOF Classic IKON 16-Piece: 2+ Year Pro Review (2025)',
  ...
  testingResults: {
    ...
    sections: [
      ...
      },
      {
        ...
        content: 'The 8" chef\'s knife, santoku, bread knife, and paring knives saw the most regular use in professional settings. These four knives alone justify the set purchase price. The chef\'s knife became the primary workhorse for protein preparation, while the santoku excelled at vegetable prep with its granton edge reducing sticking.'
      },
      {
  ...
  performanceAnalysis: {
    title: 'Why WÜSTHOF Classic IKON Delivers Professional-Grade Performance',
    sections: [
      {
        title: 'PEtec Enhanced Blades',
        content: '20% sharper than traditional German knives with twice the edge retention. Precision forging creates blades that stay sharp through heavy professional use.'
      },
      {
        title: 'Full Tang Construction',
        content: 'Steel extends through entire handle for superior balance and durability. The 58 HRC hardness provides excellent edge retention without brittleness.'
      },
      {
        title: 'Ergonomic IKON Handles',
        content: 'Curved handle design reduces hand fatigue during extended prep sessions. The difference is noticeable after just 30 minutes of continuous use.'
      },
      {
        title: 'Complete Set Value',
        content: '16 pieces including essential knives, steel, and scissors. Saves hundreds compared to buying individually while ensuring consistent quality across your entire knife collection.'
      }
    ]
  },

  // SECTION 4: PROS & CONS TITLE
  prosConsTitle: 'Pros & Cons Based on Professional Use',
  prosTitle: 'What Impressed Me',
  consTitle: 'Limitations & Considerations',

  // SECTION 5: WHO SHOULD BUY
  whoShouldBuy: {
    title: 'Who Should (and Shouldn\'t) Buy This Set',
  ...
  whereToBuy: {
    title: 'Where to Buy WÜSTHOF Classic IKON 16-Piece Set',
    introText: 'Available from authorized retailers with verified pricing and support. Compare prices to find the best deal.',
    disclaimer: 'Pricing updated daily. We earn commission at no extra cost to you. More retailers will be added soon for price comparison.'
  },
