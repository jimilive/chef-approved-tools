...
export default async function InstantPotDuoPlusReview() {
  ...
  const affiliateLink = product.affiliateLinks?.[0]?.url || 'https://amzn.to/4hBzvxq'
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-slate-800 via-slate-700 to-orange-600 text-white py-16">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl text-slate-300 mb-6">
            After 90 days of daily use and 24 years in professional kitchens, here's what you need to know before you buy
          </p>
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-800 mb-2">
                ...
                I'm currently at 90 days of daily testing across multiple cooking methods.
              </p>
        ...
        <div className="bg-orange-50 border-l-4 border-orange-600 p-6 mb-8">
          <h2 className="text-2xl font-bold mb-3 text-gray-900">Scott's Professional Verdict</h2>
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            <p>
              Over 24 years in professional kitchens, I've used commercial pressure cookers at Mellow Mushroom for stock reduction
        ...
        <section className="mb-12 bg-slate-50 p-8 rounded-xl">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            ...
            <p>
              <strong>Results:</strong> The meat was fall-apart tender, rivaling anything I've made in commercial kitchens.
              The natural release is key here—it prevents the meat from seizing up and becoming tough. However, the sauté
              function couldn't properly brown the roast. I ended up removing the mirepoix before pressure cooking because
            ...
            <p>
              <strong>Results:</strong> Dried beans in 30-40 minutes without pre-soaking, and they're creamy inside without
        ...
        <section className="mb-12">
          ...
          <div className="bg-white p-6 rounded-lg border-l-4 border-orange-600 mb-6">
            ...
            <ul className="space-y-3 text-gray-700">
              ...
              <li>• <strong>Want hands-off cooking that doesn't require monitoring</strong> — Set it and walk away</li>
              ...
              <li>• <strong>Don't mind the time investment</strong> — Total time is 1.5-2 hours for most dishes (not quick cooking—convenient cooking)</li>
              <li>• <strong>Have counter space or storage space</strong> — It's 13" x 12" x 12.5" and weighs 13 pounds</li>
            </ul>
          </div>
