...
export default function KitchenAppliancesPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: 'Kitchen Appliances', url: 'https://www.chefapprovedtools.com/guides/kitchen-appliances' }
  ])
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg">
            <div className="prose prose-slate max-w-none">
              ...
              <div className="bg-slate-50 rounded-lg p-4 my-6">
                <h3 className="font-semibold text-slate-900 mb-2">Commercial vs Consumer: 5-Year Calculation</h3>
