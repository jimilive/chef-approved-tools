...
export const metadata: Metadata = {
  ...
  description: 'Complete guide to cookware materials from 15+ years managing professional kitchens. Stainless steel, cast iron, carbon steel, and more.',
}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <header>
          ...
          <p className="text-xl text-slate-600 leading-relaxed">
            ...
            in high-volume commercial kitchens for 15+ years.
          </p>
        </header>
