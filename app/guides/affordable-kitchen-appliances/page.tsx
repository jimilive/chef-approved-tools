    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <ol className="flex space-x-2 text-sm text-gray-700">
            <li className="flex items-center">
              <Link href="/" className="text-gray-700 hover:text-orange-800 transition-colors">
                Home
              </Link>
            </li>
            <li className="flex items-center">
              <span className="mr-2">/</span>
              <Link href="/guides" className="text-gray-700 hover:text-orange-800 transition-colors">
                Guides
              </Link>
            </li>
            <li className="flex items-center">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <header className="mb-8">
          ...
          <div className="flex items-center gap-3 text-sm text-slate-700 mb-6">
        ...
        <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 text-center mb-8">
          ...
          >
            <Link
              href="/appliances"
              className="inline-block bg-orange-700 hover:bg-orange-900 text-white font-semibold px-8 py-3 rounded-lg transition-colors"
            >
