...
const categoryConfig = getCategoryConfig('cookware')
...
export default async function CookwarePage() {
  ...
  // FAQPage schema with unique cookware FAQs (NO Product schema - avoiding image/rating issues)
  const faqSchema = {
