        ...
        <div className="prose prose-lg prose-slate max-w-none bg-white rounded-xl shadow-lg p-8 mb-8">
          <div className="bg-gradient-to-br from-blue-900 to-blue-700 p-6 rounded-xl border-l-4 border-blue-600 my-8 shadow-lg">
            ...
            <p className="text-blue-100 mb-0 leading-relaxed">
              At Feierabend in Seattle, we roasted vegetables for every service—Brussels sprouts, carrots, cauliflower, butternut squash. Every single day. New cooks would throw all the vegetables on one sheet pan at 425°F and wonder why some were burnt while others were raw. Different vegetables have different densities, water contents, and sugar levels—they require different treatment. Learning proper roasting times and temperatures turned vegetables from sad side dishes into menu highlights that people ordered specifically. When I trained new cooks at Mellow Mushroom, I could tell who had line experience by how they roasted potatoes. The pros always used two pans instead of one — not for volume, but for air circulation. Those little choices separate restaurant results from home frustration. Today I&apos;m giving you the exact times, temps, and techniques that create perfect roasted vegetables every time.
            </p>
          </div>
