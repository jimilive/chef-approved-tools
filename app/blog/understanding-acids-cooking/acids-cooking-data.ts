// ============================================================================
// UNDERSTANDING ACIDS IN COOKING: THE SECRET TO BALANCED FLAVOR - Educational Blog Data
...
export const educationalData = {
  ...
  sections: [
    ...
    {
      id: "what-is-acid",
      title: "What is Acid in Cooking?",
      definition: "**Acid** refers to ingredients with low pH (below 7) that taste sour, tart, or bright. Common cooking acids include:",
      categories: [
        {
          name: "Citrus",
          items: [
            ...
            "Lime juice (pH 2-2.5)",
            "Orange juice (pH 3.5-4)",
            "Grapefruit juice (pH 3-3.5)"
          ]
        },
        {
          name: "Vinegars",
          items: [
            "Red wine vinegar (pH 2.5-3)",
            "White wine vinegar (pH 2.5-3)",
            "Balsamic vinegar (pH 2.5-3)",
            "Apple cider vinegar (pH 3-3.5)",
            "Rice vinegar (pH 4-4.5)"
          ]
        }
      ],
      restaurantReality: {
    ...
    {
      id: "why-acid-essential",
      title: "Why Acid is Essential to Flavor",
      hasIcon: true,
      reasons: [
        {
          number: 1,
          title: "Acids Brighten and Balance",
          intro: "Think of flavor like a sound system with bass, midrange, and treble controls:",
          analogy: [
            { component: "Fat", equals: "Bass", description: "rich, deep, coating", link: "/blog/fat-is-flavor" },
        ...
        {
          number: 2,
          title: "Acids Cut Through Richness",
          intro: "Rich, fatty foods need acid to balance them. This is why:",
          examples: [
            "Fried fish comes with lemon wedges",
            "Pork chops are served with apple sauce (acidic)",
            "Duck is paired with orange or cherry sauce",
            "Hollandaise (butter-heavy) includes lemon juice"
          ],
          closing: "The acid cuts through fat, preventing the dish from feeling heavy or cloying."
        },
        {
          number: 3,
    ...
    {
      id: "how-chefs-use",
      title: "How Professional Chefs Use Acid",
      techniques: [
        {
          number: 1,
          title: "Finishing Dishes",
          hasIcon: true,
          content: "The most common use: a final squeeze of lemon or splash of vinegar right before serving. This is what makes restaurant food taste \"bright\" and \"fresh.\"",
          examples: [
            "Squeeze of lemon over grilled fish or vegetables",
            "Splash of red wine vinegar in braised meats",
            "Lime juice over tacos or ceviche",
            "Balsamic reduction over roasted vegetables"
          ]
        },
        {
          number: 2,
          title: "Building Sauces and Dressings",
          content: "Vinaigrettes are essentially acid + fat + emulsifier. The acid provides brightness that balances the richness of oil.",
          classicRatio: "3 parts oil to 1 part acid (vinegar or citrus), plus mustard for emulsification and stability."
        },
        {
          number: 3,
          title: "Deglazing Pans",
          content: "After searing meat, deglazing with wine or vinegar adds acid while capturing all those browned bits (fond) stuck to the pan. The acid helps dissolve the fond into a flavorful pan sauce."
        }
      ]
    },
    {
      id: "conclusion",
      title: "The Bottom Line: Acid Completes Flavor",
      content: [
