// ============================================================================
// DUTCH OVEN SIZE GUIDE - Blog Data
// Migrated from inline to data-driven architecture
// ============================================================================

export const dutchOvenData = {
  metadata: {
    ...
    primaryKeyword: "dutch oven size guide",
    secondaryKeywords: ["dutch oven size", "what size dutch oven", "5.5 vs 7 quart dutch oven"],
    readTime: "8 min read"
  },
  ...
  sizeChart: {
    sizes: [
      { size: "3.5 Quart", capacity: "Small", idealFor: "Soups for two, small casseroles, side dishes", servings: "2–3" },
      { size: "5.5 Quart", capacity: "Medium", idealFor: "Everyday cooking, braises, breads, chili", servings: "4–6" },
      { size: "6.75–7.25 Quart", capacity: "Large", idealFor: "Family meals, roast chicken, large batches", servings: "6–8" },
      { size: "9 Quart+", capacity: "Extra Large", idealFor: "Stock, big batches, entertaining", servings: "8–12+" }
    ]
  },
