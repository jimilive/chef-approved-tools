...
export const educationalData = {
  ...
  howToSchema: {
    name: "How to Remove Rust from a Kitchen Knife",
    description:
      "Step-by-step guide to removing rust from kitchen knives using household items like vinegar, baking soda, or lemon and salt.",
    totalTime: "PT2H",
    tools: [
      "White vinegar",
      "Baking soda",
    ...
    steps: [
      {
        name: "Assess the rust severity",
        text: "Examine the blade to determine if you're dealing with surface rust (orange discoloration) or deep pitting. Surface rust responds well to home remedies. Deep pitting may require professional restoration.",
      },
      {
        name: "Choose your method",
        text: "For light rust, use baking soda paste. For moderate rust, use white vinegar soak. For stubborn rust, try Bar Keeper's Friend or a rust eraser.",
      },
      {
        name: "Apply treatment",
        text: "Follow the specific instructions for your chosen method. Most require 30 minutes to 2 hours of contact time.",
      },
      {
        name: "Scrub gently",
        text: "Use a soft cloth or sponge to remove the loosened rust. Work in the direction of the blade's grain. Avoid steel wool, which can scratch.",
      },
      {
        name: "Rinse and dry immediately",
        text: "Wash with dish soap, rinse thoroughly, and dry completely with a clean towel. Never air dry — this is how rust starts in the first place.",
      },
      {
        name: "Apply protective oil",
        text: "For carbon steel knives, apply a thin layer of food-grade mineral oil to prevent future rust.",
      },
    ],
  },

  tableOfContents: [
    { id: "why-knives-rust", title: "Why Knives Rust" },
    { id: "method-1-vinegar", title: "Method 1: White Vinegar Soak" },
    { id: "method-2-baking-soda", title: "Method 2: Baking Soda Paste" },
    { id: "method-3-lemon-salt", title: "Method 3: Lemon and Salt" },
    { id: "method-4-bar-keepers-friend", title: "Method 4: Bar Keeper's Friend" },
    { id: "method-5-rust-eraser", title: "Method 5: Rust Eraser" },
    { id: "prevention", title: "How to Prevent Rust" },
    { id: "when-to-give-up", title: "When a Knife Can't Be Saved" },
  ],

  sections: [
    {
      id: "why-knives-rust",
      title: "Why Knives Rust (And Why Mine Don't)",
      content: [
    ...
    {
      id: "method-1-vinegar",
      title: "Method 1: White Vinegar Soak",
      content: [
    ...
    {
      id: "method-2-baking-soda",
      title: "Method 2: Baking Soda Paste",
      content: [
    ...
    {
      id: "method-3-lemon-salt",
      title: "Method 3: Lemon and Salt",
      content: [
    ...
    {
      id: "method-4-bar-keepers-friend",
      title: "Method 4: Bar Keeper's Friend",
      content: [
    ...
    {
      id: "method-5-rust-eraser",
      title: "Method 5: Rust Eraser (For Serious Cases)",
      content: [
    ...
    {
      id: "prevention",
      title: "How to Prevent Rust (The Actual Solution)",
      content: [
    ...
    {
      id: "when-to-give-up",
      title: "When a Knife Can't Be Saved",
      content: [
  ...
  faq: {
    questions: [
      {
        question: "Can I use steel wool to remove rust from my knife?",
        answer:
          "I'd avoid it. Steel wool removes rust quickly but scratches the blade surface. Those scratches become initiation points for future rust. Stick with soft cloths, sponges, or dedicated rust erasers.",
      },
      {
        question: "Why does my stainless steel knife have rust?",
        answer:
          "Stainless steel resists rust — it's not rust-proof. Prolonged exposure to moisture, acidic foods, or salt can cause rust even on stainless blades. The same prevention rules apply: wash, dry immediately, store properly.",
      },
      {
        question: "Is a rusty knife dangerous to use?",
        answer:
          "Surface rust itself isn't toxic, but it indicates the knife isn't being properly maintained. Pitted rust can harbor bacteria. More practically, a rusty blade doesn't cut well and is harder to keep clean. Fix it or replace it.",
      },
      {
        question: "How long does rust removal take?",
        answer:
          "Depends on severity. Light surface rust with baking soda: about an hour. Moderate rust with vinegar: 1-4 hours. Heavily rusted blade: you might need multiple treatments over a day or two.",
      },
      {
        question: "Can I prevent rust on carbon steel knives?",
        answer:
          "Yes, but it requires consistent care. Wash and dry immediately after every use. Apply a thin layer of food-grade mineral oil before storage. Some cooks develop a protective patina intentionally. Carbon steel rewards attention and punishes neglect.",
      },
      {
        question: "What's the fastest way to remove rust from a knife?",
        answer:
          "Bar Keeper's Friend works fastest — usually within minutes. But faster isn't always better. For valuable knives, I'd start with gentler methods like baking soda and only escalate if needed.",
      },
    ],
  },
  ...
  relatedLinks: [
    ...
    { href: "/blog/carbon-steel-vs-stainless-steel-knife", title: "Carbon Steel vs Stainless Steel Knife" },
    { href: "/reviews/victorinox-fibrox-8-inch-chefs-knife", title: "Victorinox Fibrox 8-Inch Chef's Knife Review" },
  ],
};
