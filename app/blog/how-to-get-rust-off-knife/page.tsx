// ============================================================================
// HOW TO GET RUST OFF A KNIFE - Educational Blog Page (Data-Driven)
// Pattern B: Educational Content
// ============================================================================

import Link from 'next/link'
import { educationalData } from './rust-knife-data'
...
// SEO Metadata
export const metadata = generateBlogMetadata('how-to-get-rust-off-knife')
...
export default async function HowToGetRustOffKnifePage() {
  const blogMeta = getBlogMetadata('how-to-get-rust-off-knife')
  ...
  const articleSchema = generateArticleSchema({
    ...
    urlPrefix: 'blog',
    urlSuffix: 'how-to-get-rust-off-knife',
    images: []
  })
  ...
  const breadcrumbSchema = generateBreadcrumbSchema([
    ...
    { name: educationalData.breadcrumb.title, url: 'https://www.chefapprovedtools.com/blog/how-to-get-rust-off-knife' }
  ])
