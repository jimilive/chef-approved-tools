// ============================================================================
// HYDRATION HEALTH WATER INTAKE - Blog Data
...
export const hydrationData = {
  ...
  faq: {
    questions: [
      ...
      },
      {
        ...
        answer: "Build it into your cooking rhythm: 1) Keep water in arm's reach at your cooking station, 2) Drink every time a timer beeps, 3) Drink between cooking tasks (finished chopping? Drink. Done sauteing onions? Drink.), 4) Set a phone timer for every 30 minutes as a backup reminder."
      }
    ]
  },
  ...
  relatedLinks: [
    ...
    { href: "/blog/how-to-cook-perfect-pasta", text: "How to Cook Perfect Pasta" },
