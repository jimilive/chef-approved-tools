...
export const garlicData = {
  ...
  sections: [
    ...
    },
    {
      ...
      hasIcon: true,
      iconType: "sprout",
      intro: "Garlic isn't just delicious—it's also one of the healthiest foods you can eat. It's been used medicinally for thousands of years, and modern research backs up many of the traditional claims.",
      subsections: [
        {
          title: "Active Compounds in Garlic",
          content: [
            "When you crush, chop, or chew garlic, an enzyme called **alliinase** converts **alliin** (a sulfur compound) into **allicin**, the compound responsible for garlic's distinctive smell and most of its health benefits.",
        ...
        },
        {
          ...
          content: [
            ...
            "**How to maximize this benefit:** Eat garlic raw or lightly cooked. Heavy cooking reduces allicin content, so if you're eating garlic for immune support, add it at the end of cooking or use it raw in dressings and spreads."
          ]
        },
        {
          title: "Heart Health and Cholesterol",
          intro: "Garlic has been shown to:",
          benefits: [
            "Lower total and LDL (bad) cholesterol",
            "Reduce blood pressure in people with hypertension",
            "Improve circulation by promoting healthy blood vessel function",
    ...
    },
    {
      ...
      title: "Cooking with Garlic: Professional Techniques",
      hasIcon: true,
      iconType: "flame",
      intro: "How you cook garlic is just as important as how you prep it. Here are the main methods and when to use each.",
      methods: [
        {
          name: "Sautéing Garlic (1-2 Minutes)",
          result: "Aromatic, mellow, sweet",
          bestFor: "Pasta sauces, stir-fries, sautéed vegetables",
          steps: [
            "Heat oil in a pan over medium heat (not high—garlic burns easily)",
            "Add minced or sliced garlic",
            "Stir constantly for 1-2 minutes until fragrant and lightly golden",
            "Add other ingredients immediately (garlic should never cook alone for long)"
          ],
        ...
        {
          name: "Roasting Garlic (35-40 Minutes)",
          result: "Sweet, nutty, caramelized, spreadable",
          bestFor: "Spreads, dips, mashed potatoes, compound butters",
          steps: [
            "Cut the top 1/4 inch off a whole head of garlic (exposing the cloves)",
            "Drizzle with olive oil and wrap in foil",
            "Roast at 400°F for 35-40 minutes until soft and golden",
        ...
        {
          name: "Raw Garlic (Dressings, Aioli, Spreads)",
          result: "Sharp, pungent, powerful",
          bestFor: "Caesar dressing, aioli, pesto, tzatziki, anywhere you want bold garlic flavor",
          method: "Grate or mince finely and mix directly into your dish.",
          proTip: "Raw garlic gets stronger the longer it sits. If making something in advance (like aioli or dressing), reduce the amount of garlic slightly to account for flavor intensification over time."
        }
      ]
    },
    {
      id: "conclusion",
      title: "The Bottom Line: Garlic is Essential",
      content: [
      ...
      keyLessons: [
        { label: "Prep method affects flavor intensity", description: "Whole is mild, grated is strong" },
        { label: "Cooking method changes character", description: "Raw is sharp, roasted is sweet" },
        { label: "Never burn garlic", description: "Burnt garlic is bitter and ruins the dish" },
        { label: "Let chopped garlic sit 5-10 minutes", description: "Maximizes health benefits" },
        { label: "Use garlic generously", description: "It's the foundation of flavor in cuisines around the world" }
      ],
