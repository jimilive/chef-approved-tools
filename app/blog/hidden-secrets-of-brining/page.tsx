...
export default function BriningSecretsPage() {
  ...
  const articleSchema = generateArticleSchema({
    headline: briningData.metadata.title,
    description: briningData.metadata.description,
    datePublished: briningData.metadata.publishedDate,
    dateModified: briningData.metadata.lastUpdated,
    ...
    <>
      ...
      <BlogLayout breadcrumbTitle={briningData.breadcrumb.title}>
        ...
        <BlogHero
          ...
          publishedDate={briningData.metadata.publishedDate}
          lastUpdated={briningData.metadata.lastUpdated}
          readTime={briningData.metadata.readTime}
        />
