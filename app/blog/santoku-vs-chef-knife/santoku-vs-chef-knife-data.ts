export const comparisonData = {
  ...
  quickAnswer: {
    chefKnifeChoice: {
      title: "Choose a Chef's Knife If:",
      points: [
  ...
  comparisonTable: {
    title: "Santoku Knife vs Chef Knife: Key Differences",
    features: [
      {
        feature: "Origin",
        optionA: { rating: "Western", description: "French/German culinary tradition" },
        optionB: { rating: "Japanese", description: "Name means 'three virtues'" }
      },
      {
        feature: "Blade Length",
        optionA: { rating: "8-10 inches", description: "Longer reach" },
        optionB: { rating: "5-7 inches", description: "More compact" }
      },
      {
        feature: "Blade Shape",
        optionA: { rating: "Curved belly", description: "Enables rocking motion" },
        optionB: { rating: "Flat/slight curve", description: "Better for push cuts" }
      },
      {
        feature: "Tip Shape",
        optionA: { rating: "Pointed", description: "Good for detail work" },
        optionB: { rating: "Sheepsfoot", description: "Rounded, safer tip" }
      },
      {
        feature: "Edge Angle",
        optionA: { rating: "15-20 degrees", description: "More durable edge" },
        optionB: { rating: "10-15 degrees", description: "Sharper, more acute" }
      },
      {
        feature: "Weight",
        optionA: { rating: "Heavier", description: "Uses weight for cutting" },
        optionB: { rating: "Lighter", description: "Less fatiguing" }
      },
      {
        feature: "Primary Motion",
        optionA: { rating: "Rocking", description: "Tip pivots on board" },
        optionB: { rating: "Push cut / tap chop", description: "Blade lifts off board" }
      },
      {
        feature: "Steel Hardness",
        optionA: { rating: "54-58 HRC", description: "Softer, easier to sharpen" },
        optionB: { rating: "58-62 HRC", description: "Harder, holds edge longer" }
      },
      {
        feature: "Versatility",
        optionA: { rating: "Excellent", description: "True all-purpose knife" },
        optionB: { rating: "Very Good", description: "Best for vegetables" }
      },
      {
        feature: "Precision Slicing",
        optionA: { rating: "Very Good", description: "Good thin cuts" },
        optionB: { rating: "Excellent", description: "Superior thin slicing" }
      },
      {
        feature: "Vegetable Prep",
        optionA: { rating: "Very Good", description: "Handles all vegetables" },
        optionB: { rating: "Excellent", description: "Designed for this task" }
      },
      {
        feature: "Protein Work",
        optionA: { rating: "Excellent", description: "Ideal for meat and fish" },
        optionB: { rating: "Good", description: "Adequate but not optimal" }
      }
    ]
  },
  ...
  detailedSections: [
    ...
    {
      id: "technique",
      title: "How Cutting Technique Differs",
      subsections: [
        {
          title: "Chef's Knife Technique",
          content: [
        ...
        },
        {
          ...
          content: [
            ...
            "If you do a lot of Asian cooking or high-volume meal prep, the santoku's technique is actually faster once you adjust. The lighter weight and flatter blade make this up-and-down motion feel easy."
          ]
        },
        {
    ...
    {
      id: "when-to-use",
      title: "When to Use Each Knife",
      subsections: [
        {
          title: "Reach for a Chef's Knife When:",
          content: [
        ...
        {
          title: "Reach for a Santoku When:",
          content: [
        ...
        {
          title: "Professional Kitchen Reality",
          content: [
      ...
      subsections: [
        ...
        },
        {
          ...
          content: [
            ...
            "Winner: Santoku. At Feierabend, I sliced thousands of mushrooms for German cuisine. Paper-thin was the standard, and the santoku made it easy."
          ]
        },
        {
      ...
      subsections: [
        {
          ...
          content: [
            ...
            "At Feierabend, I sliced thousands of mushrooms for German cuisine. Paper-thin was the standard, and the santoku made it easy. The lighter weight meant less fatigue during high-volume prep.",
  ...
  productRecommendations: {
    chefKnife: {
      title: "Best Chef's Knife: Victorinox Fibrox Pro 8\"",
      slug: "victorinox-fibrox-8-inch-chefs-knife",
      description: "After 20+ years testing across five professional kitchens, this remains the best value chef's knife available.",
      features: [
    ...
    santoku: {
      title: "Best Santoku: Wusthof Classic Ikon 7\"",
      slug: "wusthof-classic-ikon-santoku",
      description: "After 14 years with mine (5 years professionally, 9 years at home), this santoku delivers the precision slicing that makes vegetable prep faster.",
      features: [
  ...
  faq: {
    questions: [
      {
        question: "Is a santoku knife better than a chef knife?",
        answer: "Neither is universally better. They're designed for different cutting techniques. A chef knife excels at rocking cuts and mincing. A santoku knife is faster for straight up-and-down vegetable prep. Most professional kitchens use both."
      },
      {
        question: "Should I get a santoku knife or chef's knife first?",
        answer: "Start with a chef's knife. It handles 80% of kitchen tasks competently. Add a santoku knife later when you find yourself doing heavy vegetable prep and wanting thinner, more precise slices."
      },
      {
        question: "Can a santoku replace a chef's knife?",
        answer: "For some cooks, yes. If you primarily cook vegetables and Asian-inspired dishes, a santoku could be your primary knife. However, for mincing herbs, breaking down proteins, and general versatility, a chef's knife is harder to replace."
      },
      {
        question: "Why are santoku knives so popular?",
        answer: "Santoku knives are lighter, less intimidating than large chef's knives, and excel at the vegetable prep that dominates home cooking. The flatter blade is also more intuitive for cooks who didn't grow up using the rocking technique."
      },
      {
        question: "What does santoku mean?",
        answer: "Santoku translates to 'three virtues' in Japanese, referring to the knife's ability to handle three tasks: slicing, dicing, and mincing. Some interpret it as the three foods it handles well: meat, fish, and vegetables."
      },
      {
        question: "Is santoku Japanese or German?",
        answer: "Santoku is a Japanese knife style. However, German manufacturers like Wusthof and Henckels now make santoku-style knives, often with Western-style handles and slightly different steel compositions."
      },
      {
        question: "Which knife is better for beginners?",
        answer: "A chef's knife is typically better for beginners because it's more forgiving and versatile. The curved blade and softer steel handle mistakes better than a santoku's harder, more acute edge."
      }
    ]
  }
}
