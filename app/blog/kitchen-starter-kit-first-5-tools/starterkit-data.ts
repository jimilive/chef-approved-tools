...
export const starterkitData = {
  ...
  relatedLinks: [
    { href: "/blog/how-to-choose-first-chef-knife", text: "How to Choose Your First Chef Knife" },
    { href: "/blog/cast-iron-seasoning-care", text: "Cast Iron Seasoning and Care" },
    { href: "/blog/cookware-materials-explained", text: "Cookware Materials Explained" }
  ]
}
