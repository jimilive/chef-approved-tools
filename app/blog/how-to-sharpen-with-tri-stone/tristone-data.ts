...
export const tristoneData = {
    ...
    questions: [
      {
        ...
        answer: "Western knives sharpen at 20-22 degrees per side, Japanese knives at 10-15 degrees. After 6 years sharpening knives daily at Purple Cafe, I found most German chef knives (Wusthof, Henckels) work best at 20 degrees, while Victorinox and Japanese knives prefer 15 degrees. Consistency matters more than the exact angle—maintain the same angle throughout the entire sharpening process."
      },
      {
  ...
  relatedLinks: [
    { href: "/reviews/norton-im200-tri-stone-sharpener", text: "Norton IM200 Tri-Stone Review" },
    { href: "/reviews/victorinox-fibrox-8-inch-chefs-knife", text: "Victorinox 8\" Chef Knife Review" },
