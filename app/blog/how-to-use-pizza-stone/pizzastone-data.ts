// ============================================================================
// HOW TO USE PIZZA STONE - Blog Data
  ...
  faq: {
    questions: [
      ...
      },
      {
        ...
        answer: "3/4 inch is optimal for home ovens—excellent heat retention, 45-minute preheat time, good durability, manageable weight. 1/2 inch works but requires 60-minute preheat and cools faster. 1 inch is overkill, requiring 75+ minutes to preheat and weighing 20+ pounds."
      }
    ]
  },

  relatedLinks: [
    { href: "/blog/how-to-make-marinara-sauce", text: "How to Make Marinara Sauce for Pizza" },
    { href: "/blog/knife-skills-how-to-hold-chef-knife", text: "Master Knife Skills for Pizza Prep" }
  ]
}
