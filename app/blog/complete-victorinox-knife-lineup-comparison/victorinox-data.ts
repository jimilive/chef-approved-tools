// ============================================================================
// COMPLETE VICTORINOX KNIFE LINEUP COMPARISON - Blog Data
...
export const victorinoxData = {
    ...
    knives: [
      {
        ...
        priority: "Essential",
        bestFor: "80% of cutting tasks"
      },
      {
        name: "4\" Paring Knife",
        bladeLength: "4 inches",
        priority: "Essential",
        bestFor: "Detail work, peeling"
      },
      {
        name: "Offset Bread Knife",
        bladeLength: "10.25 inches",
        priority: "Recommended",
        bestFor: "Bread, tomatoes, cakes"
      },
      {
        name: "10\" Chef's Knife",
        bladeLength: "10 inches",
        priority: "Optional",
        bestFor: "Bulk prep, large ingredients"
      },
      {
        name: "Granton Boning Knife",
        bladeLength: "6 inches",
        priority: "Specialty",
        bestFor: "Breaking down proteins"
      }
    ]
  },
  ...
  faq: {
    questions: [
      ...
      {
        question: "Do I need different knives for meat vs vegetables?",
        answer: "No. These Victorinox knives are designed for all-purpose use. The same 8-inch chef's knife works perfectly for both dicing onions and slicing chicken breast. Exception: The boning knife is specialized for protein fabrication, but even that's optional unless you're regularly working with bone-in cuts."
      }
    ]
  },

  relatedLinks: [
    { href: "/blog/paring-knife-vs-chefs-knife", text: "Paring Knife vs Chef's Knife: When to Use Which" },
    { href: "/blog/victorinox-budget-vs-wusthof-premium-knives", text: "Budget vs Premium Knives: Victorinox vs Wüsthof" }
  ]
}
