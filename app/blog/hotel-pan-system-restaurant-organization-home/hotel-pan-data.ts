...
export const hotelPanData = {
  ...
  hero: {
    ...
    introduction: [
      "After 24 years in professional kitchens and 20 years using hotel pans at home, discover why every restaurant uses this system and how it eliminates Tupperware chaos."
    ]
  },
  ...
  relatedLinks: [
    { href: "/reviews/small-plastic-hotel-pans", text: "Small Plastic Hotel Pans Review" },
    { href: "/reviews/large-plastic-hotel-pans", text: "Large Plastic Hotel Pans Review" },
    { href: "/reviews/small-metal-hotel-pans", text: "Small Metal Hotel Pans Review" },
    { href: "/reviews/large-metal-hotel-pans", text: "Large Metal Hotel Pans Review" }
  ]
}
