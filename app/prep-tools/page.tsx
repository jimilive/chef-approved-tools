...
const categoryConfig = getCategoryConfig('prep-tools')
...
export default async function PrepToolsPage() {
  ...
  return (
    <>
      ...
      {/* Breadcrumb Schema */}
      <BreadcrumbSchema items={categoryBreadcrumbs['prep-tools']} />
