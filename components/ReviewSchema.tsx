...
export default function ReviewSchema({
  ...
  const reviewSchema = {
    ...
    "author": {
      ...
      "description": "45 years of cooking, 24 years professional kitchens, former Kitchen Manager at Mellow Mushroom",
      "knowsAbout": [
...
export function ChefCredentialsSchema() {
  const personSchema = {
    ...
    "name": "Scott Bradley",
    "jobTitle": "Professional Chef & Kitchen Manager",
    "description": "Professional chef with 45 years of cooking, including 24 years in professional restaurant kitchens. Former Kitchen Manager at Mellow Mushroom, specializing in professional kitchen equipment reviews and long-term durability testing.",
    ...
    "hasOccupation": [
      ...
      },
      {
        ...
        "description": "45 years of cooking, with 24 years in professional kitchens spanning fast food to fine dining and high-volume operations",
