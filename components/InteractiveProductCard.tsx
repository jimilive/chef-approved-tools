    ...
    >
      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
        ...
        <Link
          ...
          className="flex-1 border-2 border-orange-800 text-orange-800 hover:bg-orange-800 hover:text-white font-semibold py-3 px-4 rounded-lg text-center text-sm transition-all duration-200 active:scale-95"
        >
          Review
        </Link>
      </div>
