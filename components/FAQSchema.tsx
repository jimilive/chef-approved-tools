...
export const kitchenToolsFAQs: FAQItem[] = [
  {
    ...
    answer: "Scott Bradley tests all kitchen equipment in real restaurant environments for a minimum of 6 months. With 24 years of professional kitchen experience including high-volume restaurant management, he evaluates tools based on durability, performance under high-volume conditions, and value for money."
  },
  {
  ...
  },
  {
    ...
    answer: "Scott Bradley has 24 years of professional kitchen experience, including managing high-volume kitchen operations with $80K+/month revenue. He holds a culinary degree from Seattle Central College and has worked in various restaurant environments from fine dining to high-volume operations."
  },
  {
