...
export const kitchenToolsFAQs: FAQItem[] = [
  {
    ...
    answer: "Scott Bradley tests all kitchen equipment in real restaurant environments for a minimum of 6 months. As a former Kitchen Manager at Mellow Mushroom with 23+ years of professional experience, he evaluates tools based on durability, performance under high-volume conditions, and value for money."
  },
  {
  ...
  },
  {
    ...
    answer: "Scott Bradley has 23+ years of professional kitchen experience, including managing kitchen operations at Mellow Mushroom with $80K+/month revenue. He holds a culinary degree from Seattle Central College and has worked in various restaurant environments from fine dining to high-volume operations."
  },
  {
