        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
          ...
          <div className="bg-white rounded-xl p-6 max-w-md mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full px-8 py-3 bg-orange-800 text-white font-semibold rounded-md hover:bg-orange-800 focus:ring-2 focus:ring-orange-300 focus:outline-none transition-colors"
              >
