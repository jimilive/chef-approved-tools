      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto">
            Equipment reviews based on real commercial kitchen testing and 15+ years of industry experience
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-8 text-center">
          <div className="max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold text-orange-700 mb-4">15+ Years Kitchen Management Experience</h3>
        ...
        <div className="text-center mt-8">
          <p className="text-slate-600 mb-4">
            Get professional equipment insights from 15+ years of kitchen management experience
          </p>
          <a
            href="/newsletter"
